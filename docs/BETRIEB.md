...
## Verbindungsprüfung und Aktivierung

Bei ausdrücklich aktivierter Serveroption PROVIDER_ACTIVATION=true prüft der Hintergrunddienst die gespeicherte Anbieter-Konfiguration einmal je Speicherstand: eine protokollierte Brave-Suche und ein synthetischer Chat-Completions-JSON-Test. Beide nutzen das Tagesbudget. Erst bei beidseitigem Erfolg wird der bestehende Zeitplan aktiviert. Fehler aktivieren ihn nicht. Erneutes Speichern der Anbieter-Konfiguration erlaubt einen erneuten Test; keine Dauerschleife kostenpflichtiger Fehlversuche. Ergebnis und Zeitpunkt stehen unter Betrieb & Team. Der synthetische Test ersetzt weder die fachliche Prüfung noch einen vollständigen Recherchelauf.
